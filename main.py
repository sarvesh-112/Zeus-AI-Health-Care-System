...
def home():
    ...
    dis_des, precautions, meds, rec_diet, wrkout = helper(predicted_disease)

    my_precautions = [i for i in precautions[0]]

    return render_template('index.html', predicted_disease=predicted_disease, dis_des=dis_des,
                           my_precautions=my_precautions, medications=meds, my_diet=rec_diet,
                           workout=wrkout, symptoms=list(symptoms_dict.keys()))
